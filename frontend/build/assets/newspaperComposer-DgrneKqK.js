import{r as n,j as e,o as T}from"./index-D7i1GXSH.js";import{G as oe}from"./index-Cohpzlek.js";/* empty css                   */import{Q as de,B}from"./react-toastify.esm-7QKpu2Dh.js";/* empty css                      */import{b as ce,a as H}from"./index.esm-BQoNxqCC.js";import{C as f,a as d}from"./CRow-BLghyscU.js";import{C as W,a as G}from"./CCardBody-VsFDQUom.js";import{C as U}from"./CCardHeader-CzJwRT5k.js";import{C as me}from"./CForm-b_B6yHIb.js";import{C as o}from"./CFormControlWrapper-BayNpT4r.js";import{C as x}from"./CFormInput-DgLLBXQY.js";import{C as R}from"./CFormCheck-BuXnNon6.js";const $e=()=>{const w={"Empower Her":"danger",Tech:"success",Entrepreneurship:"warning",Green:"info"},[D,F]=n.useState(""),[c,E]=n.useState([]),[q,M]=n.useState([]),[K,V]=n.useState([]),[J,Y]=n.useState("english"),[u,P]=n.useState([]),[$,Q]=n.useState(""),[j,X]=n.useState([]),[h,Z]=n.useState(1e3),[y,_]=n.useState(""),[b,O]=n.useState(""),[v,ee]=n.useState(""),[C,te]=n.useState(""),[s,re]=n.useState(null),[i,A]=n.useState({target:!0,subject:!0,category:!0,n:!0,logo:!0,image1:!0,image2:!0,image3:!0}),[ge,z]=n.useState(""),se=async t=>{t.preventDefault();const a=`
      <table
        align="center"
        role="presentation"
        border="0"
