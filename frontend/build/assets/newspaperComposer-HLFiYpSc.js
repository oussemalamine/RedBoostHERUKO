import{r as n,j as e,o as T}from"./index-B4HzPnhB.js";import{G as oe}from"./index-Bls6YQFN.js";/* empty css                   */import{Q as de,B}from"./ReactToastify-CYMF7lSo.js";import{b as ce,a as H}from"./index.esm-Dvd6sc2g.js";import{C as f,a as d}from"./CRow-BYbcowPv.js";import{C as W,a as G}from"./CCardBody-6PHFK4Cc.js";import{C as U}from"./CCardHeader-CVW7LMK6.js";import{C as me}from"./CForm-CLucEim6.js";import{C as o}from"./CFormControlWrapper-BhvmIBcS.js";import{C as x}from"./CFormInput-CB3FQ2Ie.js";import{C as R}from"./CFormCheck-4CjMjjgu.js";const Re=()=>{const w={"Empower Her":"danger",Tech:"success",Entrepreneurship:"warning",Green:"info"},[D,F]=n.useState(""),[c,E]=n.useState([]),[q,M]=n.useState([]),[K,V]=n.useState([]),[J,Y]=n.useState("english"),[u,P]=n.useState([]),[$,Q]=n.useState(""),[j,X]=n.useState([]),[h,Z]=n.useState(1e3),[y,_]=n.useState(""),[b,O]=n.useState(""),[v,ee]=n.useState(""),[C,te]=n.useState(""),[s,re]=n.useState(null),[i,A]=n.useState({target:!0,subject:!0,category:!0,n:!0,logo:!0,image1:!0,image2:!0,image3:!0}),[ge,z]=n.useState(""),se=async t=>{t.preventDefault();const a=`
      <table
        align="center"
        role="presentation"
        border="0"
